...
function Next() {
    ...
    //2. Mova o bloco para a posição especificada - ou seja, mova o [centro de si mesmo] para a posição alvo
    ...
    for (let i = 0; i < block.children.length; i++) {
        ...
        // block.children[1].innerText = index; //Numeração para fácil depuração
